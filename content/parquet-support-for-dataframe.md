...
[`dataframe`](https://github.com/mchav/dataframe) already ships a working Parquet reader and includes a growing Parquet implementation (`DataFrame.IO.Parquet.*`). This project makes Parquet a **first-class, production-ready I/O format inside `dataframe`**, by:
